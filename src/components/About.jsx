...
export default function About() {
    return (
        <section className="w-full min-h-[400px] py-12 flex items-center justify-center animate-fade-in">
            ...
            <div className="max-w-[1000px] w-full px-6 flex flex-col md:flex-row items-center justify-center gap-10 md:gap-[150px]">
                ...
                <div className="flex-1 flex flex-col justify-center gap-[25px]">
                    <h2 className="font-bebas text-[36px] md:text-[40px] leading-[1.2] text-[#172B6A] uppercase">
                        About Us
                    </h2>

                    <p className="font-montserrat text-[14px] md:text-[16px] leading-[1.6] text-[#010512]">
